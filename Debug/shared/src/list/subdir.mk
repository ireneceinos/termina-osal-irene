...
C_SRCS += \
../shared/src/list/list.c 

OBJS += \
./shared/src/list/list.o 

C_DEPS += \
./shared/src/list/list.d 


# Each subdirectory must supply rules for building sources it contributes
shared/src/list/%.o shared/src/list/%.su shared/src/list/%.cyclo: ../shared/src/list/%.c shared/src/list/subdir.mk
...
clean: clean-shared-2f-src-2f-list

clean-shared-2f-src-2f-list:
	-$(RM) ./shared/src/list/list.cyclo ./shared/src/list/list.d ./shared/src/list/list.o ./shared/src/list/list.su

.PHONY: clean-shared-2f-src-2f-list
