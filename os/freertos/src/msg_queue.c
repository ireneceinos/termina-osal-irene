...
typedef struct {
    ...
    rtems_id freertos_msg_queue_id;
...
void __termina_os_msg_queue__init(const __termina_id_t queue_id,
    ...
    *status = 0;
    ...
    if (freertos_message_queue_create(name, msg_queue->message_queue_size,
...
void __termina_os_msg_queue__send(const __termina_id_t queue_id,
    ...
    *status = 0;
    ...
    if (freertos_message_queue_send(freertos_queue->freertos_msg_queue_id, data,
...
void __termina_os_msg_queue__recv(const __termina_id_t queue_id,
    ...
    *status = 0;
    ...
    if (freertos_message_queue_receive(freertos_queue->freertos_msg_queue_id, data,
                                    &size, RTEMS_WAIT, 
